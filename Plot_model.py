...
def scatter3D(GRID, prop, weight, colordim = [False], NRand = 1000, axisunit = 1.0, palette = 'hot',
              colorscale = 'uniform', vmin = None, vmax = None, colorlabel = '', output = 'figscatter.png', show = True):
    ...
    sp = ax.scatter(x,y,z, s = 5, c = prop2plot, cmap = palette, marker = '+', vmin = vmin, vmax = vmax)
